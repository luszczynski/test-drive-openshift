...
![](../../.gitbook/assets/selection_063-1.png)
...
![](../../.gitbook/assets/selection_064-1.png)
...
{% embed url="https://docs.openshift.com/container-platform/3.11/using\_images/s2i\_images/index.html" %}

{% embed url="https://docs.openshift.com/container-platform/3.11/creating\_images/s2i.html" %}

{% embed url="https://blog.openshift.com/create-s2i-builder-image/" %}

{% embed url="https://github.com/openshift/source-to-image" %}
