...
{% embed url="https://docs.openshift.com/container-platform/3.11/admin\_guide/quota.html" %}

{% embed url="https://docs.openshift.com/container-platform/3.11/admin\_guide/multiproject\_quota.html" %}

{% embed url="https://docs.openshift.com/container-platform/3.11/dev\_guide/compute\_resources.html" %}

{% embed url="https://docs.openshift.com/container-platform/3.11/admin\_guide/overcommit.html" %}
